...
import com.topia.chat.databinding.ItemReceiveGroupBinding;
import com.topia.chat.databinding.ItemSentBinding;
import com.topia.chat.databinding.ItemSentGroupBinding;
                    ...
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if(snapshot.exists()) {
                                ...
                                viewHolder.binding.name.setText("@" + user.getFirstName()+user.getLastName());
                            }
                        }
